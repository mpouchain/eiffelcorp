...
public class IfServiceServiceLocator extends org.apache.axis.client.Service implements services.IfServiceService {
    ...
    public services.IfService getIfService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            services.IfServiceSoapBindingStub _stub = new services.IfServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.IfService.class.isAssignableFrom(serviceEndpointInterface)) {
                services.IfServiceSoapBindingStub _stub = new services.IfServiceSoapBindingStub(new java.net.URL(IfService_address), this);
                _stub.setPortName(getIfServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services", "IfServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services", "IfService"));
        }
