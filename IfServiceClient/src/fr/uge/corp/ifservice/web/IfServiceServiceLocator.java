...
public class IfServiceServiceLocator extends org.apache.axis.client.Service implements fr.uge.corp.ifservice.web.IfServiceService {
    ...
    public fr.uge.corp.ifservice.web.IfService getIfService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.corp.ifservice.web.IfServiceSoapBindingStub _stub = new fr.uge.corp.ifservice.web.IfServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.corp.ifservice.web.IfService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.corp.ifservice.web.IfServiceSoapBindingStub _stub = new fr.uge.corp.ifservice.web.IfServiceSoapBindingStub(new java.net.URL(IfService_address), this);
                _stub.setPortName(getIfServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "IfServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "IfService"));
        }
