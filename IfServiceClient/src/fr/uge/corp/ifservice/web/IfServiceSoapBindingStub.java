...
public class IfServiceSoapBindingStub extends org.apache.axis.client.Stub implements fr.uge.corp.ifservice.web.IfService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "descriptionReturn"));
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://common.ifservice.corp.uge.fr", "Product"));
        oper.setReturnClass(fr.uge.corp.ifservice.common.Product[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "getAvailableProductsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "id"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "p"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://common.ifservice.corp.uge.fr", "Product"), fr.uge.corp.ifservice.common.Product.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
    ...
    public java.lang.String description() throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "description"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public fr.uge.corp.ifservice.common.Product[] getAvailableProducts() throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "getAvailableProducts"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (fr.uge.corp.ifservice.common.Product[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (fr.uge.corp.ifservice.common.Product[]) org.apache.axis.utils.JavaUtils.convert(_resp, fr.uge.corp.ifservice.common.Product[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
  ...
  throw axisFaultException;
    ...
    public void validateCart(int id) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "validateCart"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
  ...
  throw axisFaultException;
    ...
    public void addToCart(int id, fr.uge.corp.ifservice.common.Product p) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://web.ifservice.corp.uge.fr", "addToCart"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id), p});
