...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements web.services.BankServiceService {
    ...
    public web.services.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            web.services.BankServiceSoapBindingStub _stub = new web.services.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (web.services.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                web.services.BankServiceSoapBindingStub _stub = new web.services.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.web", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.web", "BankService"));
        }
