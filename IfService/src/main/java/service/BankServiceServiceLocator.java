...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements service.BankServiceService {
    ...
    public service.BankService getBankService() throws javax.xml.rpc.ServiceException {
    ...
    public service.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.BankServiceSoapBindingStub _stub = new service.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                service.BankServiceSoapBindingStub _stub = new service.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service", "BankService"));
        }
