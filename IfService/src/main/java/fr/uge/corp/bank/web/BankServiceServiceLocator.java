...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements fr.uge.corp.bank.web.BankServiceService {
    ...
    public fr.uge.corp.bank.web.BankService getBankService() throws javax.xml.rpc.ServiceException {
    ...
    public fr.uge.corp.bank.web.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.corp.bank.web.BankServiceSoapBindingStub _stub = new fr.uge.corp.bank.web.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.corp.bank.web.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.corp.bank.web.BankServiceSoapBindingStub _stub = new fr.uge.corp.bank.web.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.bank.corp.uge.fr", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.bank.corp.uge.fr", "BankService"));
        }
